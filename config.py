...
# ============= TESTNET / MAINNET =============
# Testnet kullanmak için BYBIT_TESTNET=true olarak set et
...
ATR_RATIO_MIN: float = 0.8      # Minimum ATR oranı

# Chandelier Exit
CE_PERIOD: int = 22             # Standart Chandelier Exit periyodu
CE_INITIAL_MULTIPLIER: float = 1.0   # 1 ATR geride başlangıç
CE_TIGHT_MULTIPLIER: float = 0.5     # 1 ATR kârdan sonra 0.5 ATR geride
...
BE_TRIGGER_ATR: float = 0.5          # 0.5 ATR kârda BE'ye taşı
BE_OFFSET_ATR: float = 0.2           # Entry + 0.2 ATR kâr garantile
CE_TIGHTEN_TRIGGER_ATR: float = 1.0  # 1 ATR kârda CE sıkılaşır

# Emir tipi (limit emir, market gibi dolması için slip)
LIMIT_SLIPPAGE: float = 0.0005       # %0.05

# ============= ZAMANLAMA =============
KLINE_INTERVAL_30M: str = "30"       # Bybit interval string
KLINE_INTERVAL_2H: str = "120"
KLINE_LIMIT: int = 250               # Çekilecek mum sayısı

EXIT_SCAN_INTERVAL_SEC: int = 60     # Çıkış taraması her 60 saniye
